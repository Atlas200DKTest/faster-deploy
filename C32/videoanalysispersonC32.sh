...
main()
{
    ...
    git clone https://gitee.com/Atlas200DK/sample-videoanalysisperson.git $HOME/AscendProjects/sample-videoanalysisperson --branch 1.3x.0.0
    if [[ $? -ne 0 ]];then
    ...
    echo "[INFO] Please follow the link from the 编译 step in Readme to continue running the case.(https://gitee.com/Atlas200DK/sample-videoanalysisperson/tree/1.3x.0.0/)"
}
main
