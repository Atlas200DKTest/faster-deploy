...
main()
{
    ...
    if [[ $C31_flag ]];then
        ...
        if [ $response"z" = "Nz" ] || [ $response"z" = "nz" ]; then
            ...
            echo "[INFO] Please manually delete $HOME/AscendProjects/sample-carplaterecognition director and re-execute this script"
            return 1
        else
    ...
    git clone https://gitee.com/Atlas200DK/sample-carplaterecognition.git $HOME/AscendProjects/sample-carplaterecognition --branch 1.3x.0.0
    if [[ $? -ne 0 ]];then
    ...
    echo "https://gitee.com/Atlas200DK/sample-carplaterecognition/tree/1.3x.0.0/"
}
main
