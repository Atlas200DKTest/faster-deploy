...
main()
{
    echo "videoanalysispersonapp prepareing"
    ...
    if [[ $C31_flag ]];then
        ...
        if [ $response"z" = "Nz" ] || [ $response"z" = "nz" ]; then
            ...
            echo "[INFO] Please manually delete $HOME/AscendProjects/sample-videoanalysisperson director and re-execute this script"
            return 1
        else
